...
public class DisplayQuestionsinResponse extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_questionsin_response);

        nameOfSurvey = getIntent().getExtras().getString("survey_name");
        setTitle(nameOfSurvey);
    }
    ...
    private void displayDatabaseInfo() {
        ...
        TextView displayView = (TextView) findViewById(R.id.textview_in_response);
        ...
        ListView lv = (ListView) findViewById(R.id.listofquestionsin_response);
        lv.setAdapter(quesAdapter);

        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {

                Intent intent = new Intent(DisplayQuestionsinResponse.this,ViewResponses.class);
